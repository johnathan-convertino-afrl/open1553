...
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_system_clk_wiz_48mhz_0] -max -add_delay 1.000 [get_ports {pmod_ja[1]}]
...
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_system_clk_wiz_48mhz_0] -max -add_delay 1.000 [get_ports {pmod_ja[3]}]
