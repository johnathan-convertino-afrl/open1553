...
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_system_clk_wiz_48mhz_0] -max -add_delay 4.000 [get_ports uart_rx]
...
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_system_clk_wiz_48mhz_0] -max -add_delay 4.000 [get_ports uart_tx]
