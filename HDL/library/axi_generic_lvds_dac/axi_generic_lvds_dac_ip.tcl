...
adi_ip_create axi_generic_lvds_dac
adi_ip_files axi_generic_lvds_dac [list \
  ...
  "axi_generic_lvds_dac_channel.v" \
  "axi_generic_lvds_dac_core.v" \
  "axi_generic_lvds_dac_if.v" \
  "axi_generic_lvds_dac_constr.xdc" \
  "axi_generic_lvds_dac.v" ]

adi_ip_properties axi_generic_lvds_dac

adi_init_bd_tcl
adi_ip_bd axi_lvds_dac "bd/bd.tcl"
